...
class FirstPersonControls extends Controls {
	...
	constructor( object, domElement = null ) {
		...
		this.active = false;  // activate mouse look when elt is clicked
...
function onPointerMove( event ) {
	...
	this._pointerX = event.offsetX - this._viewHalfX;
	this._pointerY = event.offsetY - this._viewHalfY;
	console.log([this._pointerX,this._pointerY]);
